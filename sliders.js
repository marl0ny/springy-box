...
createScalarParameterSlider(controls, 6, "Spring Strength 1 (N)", "float", {'value': 600.0, 'min': 300.0, 'max': 1000.0, 'step': 10.0});
createScalarParameterSlider(controls, 7, "Spring Strength 2 (N)", "float", {'value': 600.0, 'min': 50.0, 'max': 1000.0, 'step': 10.0});
createScalarParameterSlider(controls, 8, "Drag Const. (Kg/s)", "float", {'value': 0.0002, 'min': 0.0, 'max': 0.001, 'step': 1e-05});
...
createScalarParameterSlider(controls, 12, "Friction Const. - floor & walls (Kg/s)", "float", {'value': 1.0, 'min': 0.0, 'max': 2.0, 'step': 0.1});
